...
class _FoodDetailPageState extends State<FoodDetailPage> {
  int _quantity = 1;
  final int _pricePerItem = 450; // Assuming the price is fixed for this item
          ...
          children: [
            ...
            const Row(
              children: [
                ...
                Text("FREE delivery for every Friday")
              ],
            ),
            const SizedBox(
              height: 15,
  ...
  // Calculate the total amount and convert it to double
  double _calculateTotalAmount() {
    return (_quantity * _pricePerItem).toDouble();
  }
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(
              "Total ${_calculateTotalAmount()} TK",
            ...
            ButtonContainerWidget(
              ...
              title: "Add to cart",
              onTap: () {
                // Navigate to the PaymentScreen with the amount parameter
                Navigator.push(
                    context,
                    MaterialPageRoute(
